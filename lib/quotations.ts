...
export type Quotation = { id: string; quoteDate: string; slipNo: string; vendorCode?: string; vendorName: string; managerCode?: string; managerName?: string; validUntil?: string; status: QuotationStatus; taxType?: string; currency?: string; project?: string; remarks?: string; item: string; itemCode?: string; quantity: number; amount: number; vat: number; total: number; convertedSalesPlanId?: string; lines?: QuotationLine[] };
