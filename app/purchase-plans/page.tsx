...
type TabKey = "all" | PurchasePlanStatus;
...
export default function PurchasePlansPage() {
  ...
  function vendorCodeName(r: PurchasePlan) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            발주계획 전표를 조회하고 진행상태를 관리합니다. (목업 데이터)
          </p>
        </div>
      ...
      <div className="flex flex-wrap gap-1 border-b border-slate-200 pb-0">
        {PURCHASE_PLAN_STATUS_TABS.map((t) => {
                  ...
                  filtered.map((r) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-2">
                        ...
                        >
                          {PURCHASE_PLAN_STATUS_LABEL[r.status]}
                        </Badge>
                      </td>
                    </tr>
                  ))
