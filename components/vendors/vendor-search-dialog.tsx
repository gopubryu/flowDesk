...
import { VendorRegisterDialog } from "./vendor-register-dialog";
...
export function VendorSearchDialog({ open, onOpenChange, onSelect }: Props) {
  ...
  function handleRowActivate(vendor: Vendor) {
        ...
        >
          <div className="border-b border-slate-100 bg-gradient-to-r from-indigo-50 to-slate-50 px-5 py-4 pr-12">
            <DialogHeader className="mb-0">
              <DialogTitle className="text-base text-slate-900">거래처 검색</DialogTitle>
                      ...
                      rows.map((vendor) => (
                        <tr
                          ...
                          className={cn(
                            ...
                            selectedCode === vendor.code && "bg-indigo-50"
                          )}
                          onClick={() => handleRowActivate(vendor)}
                          onDoubleClick={() => handleRowActivate(vendor)}
                        >
